#!/usr/bin/env python3
"""
Step 5: Filter datasets by organism, tissue, and publication status
...
Usage:
    ...
    python bin/5_filter_datasets.py --organism "Homo sapiens" --tissue "lung" --no-preprints
    python bin/5_filter_datasets.py --organism "Homo sapiens" --tissue "pancreas|isle" --no-preprints
"""
...
DATA_DIR = "data"
DEFAULT_INPUT = os.path.join(DATA_DIR, "all_datasets_with_normal_counts.csv")
...
Examples:
  ...
  python 5_filter_datasets.py --organism "Homo sapiens" --output homo_sapiens.csv
  
  # Filter for Homo sapiens lung tissue (no preprints)
  python 5_filter_datasets.py --organism "Homo sapiens" --tissue "lung" \\
    --no-preprints --output homo_sapiens_lung_harvester.csv
  
  # Filter for Homo sapiens pancreas (including islets)
  python 5_filter_datasets.py --organism "Homo sapiens" --tissue "pancreas|isle" \\
    --no-preprints --output homo_sapiens_pancreas_harvester.csv
  
  # Filter for disease datasets
  python 5_filter_datasets.py --organism "Homo sapiens" --disease "cancer" \\
    ...
    print("=" * 70)
    print("CellxGene Data Harvester - Step 5: Filter Datasets")
    print("=" * 70)
