...
# 4. Count normal cells in each dataset
# 5. Filter by organism and tissue
#
...
echo "Step 4/5: Counting normal cells (this takes a while - downloads H5AD files)..."
python3 "$BIN_DIR/4_count_normal_cells.py"
echo ""

# Step 5: Filter datasets
echo "Step 5/5: Filtering datasets..."
echo ""
...
# Homo sapiens (all)
python3 "$BIN_DIR/5_filter_datasets.py" \
...
echo "  - $DATA_DIR/all_datasets_with_normal_counts.csv"
echo "  - $DATA_DIR/homo_sapiens_all.csv"
